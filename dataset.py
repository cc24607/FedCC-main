...
def Load_Datasets(name_dataset):
    if name_dataset=='emnist':
        ...
        train_data = datasets.EMNIST(root="./datas/EMNIST", split="byclass", download=True, train=True,transform=trans)
        test_data = datasets.EMNIST(root="./datas/EMNIST", split="byclass", download=True, train=False,transform=trans)
...
if __name__ == '__main__':
    train_data,test_data=Load_Datasets('cifar10')
